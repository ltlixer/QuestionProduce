...
public class WordSimilarity {
	public static void main(String[] args) {
		System.out.println(new WordSimilarity().simWord("兆", "烧"));
	}
    // 词库中所有的具体词，或者义原
    private  Map<String, List<Word>> ALLWORDS = new HashMap<String, List<Word>>();
    /**
    ...
    public  void loadGlossary() {
        ...
        try {
        	InputStreamReader isr = new InputStreamReader(new FileInputStream("src/main/webapp/resources/dict/glossary.dat"), "GBK");
