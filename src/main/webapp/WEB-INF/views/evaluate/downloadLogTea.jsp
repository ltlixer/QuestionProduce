...
<body>
	<div class="bodyDiv">
		<h2><spring:message code="tealog"/> </h2>
		...
		<table  class="editTab" id="table">
					...
					<tr><td colspan="3" align="center"><input type="submit" onclick="return addE('courseIds')" value="<spring:message code="downtealog"/>" style="width: 100px"
						class="btnPaleGreen" />
						&nbsp;&nbsp;<a href="#" onclick="return view('courseIds')"><spring:message code="looklist"/></a>
						</td></tr>
		</table>
		</form>
		<hr color="#00aaff">
		<table border="1" class="editTab" id="viewLog">
				<tr>
					<th colspan="6"><spring:message code="teaSendAssList"/></th>
				</tr>
				<tr>
