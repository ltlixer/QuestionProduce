...
<html>
  ...
  $(function(){
	...
	<frameset rows="60,*,28" frameborder="no" framespacing="0" >
  			<frame name="zh_CN" src="<c:url value='/resources/html_zh_CN/teatop.html?s=${tea.teaNum}'/>" scrolling="no"></frame>
  			<frame name="en" src="<c:url value='/resources/html_en/teatop.html?s=${tea.teaNum}'/>" scrolling="no"></frame>
	        <frameset id="centerSet" cols="220,10,*" frameborder="no" framespacing="0">
				<frame name="zh_CN" src="<c:url value="/resources/html_zh_CN/tealeft.html" />" scrolling="no"></frame>
				<frame name="en" src="<c:url value="/resources/html_en/tealeft.html" />" scrolling="no"></frame>
