...
<div class="body">
	<!-- header -->
	<jsp:include page="../../include/student/header.jsp"></jsp:include>
	<!-- Main Page -->
	<div class="content">
		<!-- sidebar左侧导航栏 -->
		<jsp:include page="../../include/student/sidebar.jsp"></jsp:include>
	...
	<!-- footer -->	
	<jsp:include page="../../include/student/footer.jsp"></jsp:include>		
</div>
